...
from evaluate import (validate_dsec, validate_chairs, validate_things, validate_sintel, validate_kitti,
...
def main(args):
    ...
    if args.eval:
        ...
        if 'dsec' in args.val_dataset:
            results_dict = validate_dsec(model_without_ddp,
